...
- `docs/drafthorse/framework/references.md` — add a cross-reference to the notation (currently absent, call-sites gap); fix the "References is the data utility" number-agreement defect in passing (final noun depends on [plan-utilities-term.md](plan-utilities-term.md)).
