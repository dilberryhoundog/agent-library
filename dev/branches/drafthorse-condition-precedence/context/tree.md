...
│   ├── 00-INDEX.md
│   ├── architectural.md
│   ├── plan-error-step-naming.md
│   ├── plan-load-bearing-slots.md
│   ├── plan-preamble-prose.md
│   ├── plan-slot-removal.md
│   ├── plan-step-functions.md
│   ├── plan-step-shape-examples.md
│   └── prd.md
├── prompts
│   ├── .keep
│   ├── discover_prompt.md
