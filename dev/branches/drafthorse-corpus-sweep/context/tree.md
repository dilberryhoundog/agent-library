...
├── history
│   ├── .keep
│   ├── 1480a71f_drafthorse-corpus-sweep-executed.txt
│   ├── ab13fefd_drafthorse-step-anatomy-spec-migration.txt
│   └── fff9aa06_wave4-pilot-migration-dehold-retired.txt
├── plans
│   ├── .keep
│   ├── architectural.md
│   └── prd.md
...
├── reviews
│   ├── .keep
│   ├── corpus-sweep-audit-results.json
│   └── corpus-sweep-migration-results.json
├── tasks
│   ├── corpus-sweep
│   │   ├── brief-6b-harvest.md
│   │   ├── brief-agent-commit.md
│   │   ├── brief-agent-push.md
│   │   ├── brief-agent-switch.md
│   │   ├── brief-audit.md
│   │   ├── brief-breaking-change-detector.md
│   │   ├── brief-classroom-handovers.md
│   │   ├── brief-classroom.md
│   │   ├── brief-common.md
│   │   ├── brief-course-researcher.md
│   │   ├── brief-doc-reviewer.md
│   │   ├── brief-drafthorse-42.md
│   │   ├── brief-git-box.md
│   │   ├── brief-git-robot.md
│   │   ├── brief-spec-check.md
│   │   └── brief-versioning.md
