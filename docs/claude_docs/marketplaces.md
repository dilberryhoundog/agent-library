...
If you need to share files across plugins, use symlinks. See [Plugin caching and file resolution](/en/plugin_reference#plugin-caching-and-file-resolution) for details.
</Note>
